...
<head>
    ...
    <link href="https://cdn.datatables.net/2.1.8/css/dataTables.bootstrap4.min.css"
          rel="stylesheet">
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets/admin/vendors/css/report/report.css')}}">
...
@if(auth()->user()->type == 'admin_branch')
    @include('adminBranches.includes.sidebar')
@endif

@if(auth()->user()->type == 'admin_panel')
...
<script
    src="https://cdn.datatables.net/2.1.8/js/dataTables.bootstrap4.min.js">
</script>
